...
test .src calls with its initialization lambda.  It's convenient here because we can just not
...
individual pybind11 test .src files), but most likely not what you want when using pybind11
productively.
