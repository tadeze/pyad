...
// General lib header of SYCL target for Tensor Module
...
// tuple construction
#lib "TensorSyclTuple.h"

// counting number of leaf at compile time
#lib "TensorSyclLeafCount.h"
