...
static void fp(long N, double T, double *Y, double *YP)
{
	...
	V[0] = Y[16]+Y[15]+0.1188*(Z[1]*Z[6]-Z[4]*Z[8]);
	Z[4] = 0.1188*Z[4];
	Z[12] = 0.70835*Z[0];
	Z[1] = 0.1188*Z[1];
	Z[13] = 0.70835*Z[2];
	...
	V[1] = Y[17]+Y[14]-Z[14]*Z[8]-Z[6]*Z[15]+0.155*(Z[0]*(Z[13]*Z[11]+Z[1]*Z[10])-Z[2]*(Z[12]*Z[11]+Z[4]*Z[10]));
	DecompCInc(2,M,2,P);
	SolveCInc(2,M,2,P,V);
	YP[1] = V[0];
	YP[3] = V[1];
...
static void SolverSetup(double t0, double *ic, double *u, double *p, double *y, double h, SolverStruct *S)
{
	...
	S->w[11] =  7.85398163397448315e+01;
	S->w[12] =  0.00000000000000000e+00;
	S->w[13] =  7.85398163397448315e+01;
